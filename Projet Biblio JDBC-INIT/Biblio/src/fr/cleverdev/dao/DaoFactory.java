...
public class DaoFactory {
	...
	public static DaoFactory getInstance() {
		if ( DaoFactory.instanceSingleton == null ) {
			try {
			      ...
			      DaoFactory.instanceSingleton = new DaoFactory("jdbc:postgresql://localhost/biblio","postgres","lirani");
	...
	// cette  methode prend une connection en parametre en pr�sagent que l'on pourrait en utiliser plusieurs
